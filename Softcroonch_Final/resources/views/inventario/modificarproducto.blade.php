...
@section('seccion')
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">módulo <small>modificar producto</small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para modificar los productos del inventario, deberas de llenar todos los campos para poder modificar el producto
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <input type="text" class="tooltips-general material-control" id="idproducto" name="codigo" placeholder="Escribe aquí el código del producto" pattern="[0-9]{1,20}" required="" maxlength="20" >
                                <label>Código</label>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
