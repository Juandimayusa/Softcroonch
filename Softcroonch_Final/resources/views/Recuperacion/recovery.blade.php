...
<br>
  ...
  <meta property="og:title" content="Casa">
  <meta property="og:type" content="website">
  <form class="needs-validation" method="post" action="Siute" novalidate>
    <p class="form-link">Ingresa tu correo electrónico y te enviaremos un enlace para que recuperes la contraseña de tu cuenta.</p>
    ...
    <p class="form-link">¿Deseas iniciar sesion?
      <a class="registro" target="blank" href="{{asset('login')}}">Iniciar Sesion</a>

    </p>
    <p class="form-link">¿Deseas ir a la pagina principal?
      <a class="registro" target="blank" href="{{asset('/')}}">Inicio</a>
