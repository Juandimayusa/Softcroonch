...
@section('seccion')
         ...
         <div class="container-fluid"  style="margin: 40px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido al inventario, selecciona una categoría de la lista para empezar, si deseas buscar un producto por nombre o código has click en el icono &nbsp; <i class="zmdi zmdi-search"></i> &nbsp; que se encuentra en la barra superior
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="inventarioinsumos">Insumos</a></li>
                        <li class="active">Producto Final</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">inventario producto final</h2>
            <div class="div-table">
                ...
                <div class="div-table-row">
                    ...
                    <div class="div-table-cell">
                        <a href="modificarproducto"><button class="btn btn-success"><i class="zmdi zmdi-refresh"></i></button></a>
                    </div>
                    <div class="div-table-cell">
